...
Original file is located at
    https://colab.research.google.com/drive/1lc8zr4zx8O4XK3m1XEiqoHDflvghVuFA
"""
...
# --- Funkcja rysująca Świętego Mikołaja ---
def draw_santa():
    ...
    # Współrzędne centralne Mikołaja
    ...
    ax.add_patch(patches.Rectangle((center_x - 2.0, 3.5), body_width, body_top - 3.5, color=CZERWONY)) # Płaszcz
    ax.add_patch(patches.Rectangle((center_x - 2.0, body_top), body_width, 0.5, color=BIALY)) # Futro na kołnierzu
    ...
    # Dodaj tytuł (wyświetlany w Streamlit jako tekst)
    plt.title("Święty Mikołaj z widoczną twarzą, prezentami i Choinką")

    return fig

# --- Główna sekcja aplikacji Streamlit ---
st.title("🎄 Święty Mikołaj w Streamlit 🧑‍💻")
st.write("To jest symboliczny rysunek Mikołaja stworzony przy użyciu biblioteki Matplotlib i wyświetlony w Streamlit.")

# Wywołanie funkcji rysującej i wyświetlenie wykresu za pomocą st.pyplot()
santa_figure = draw_santa()
st.pyplot(santa_figure)

# Dodatkowe informacje
st.caption("Aby uruchomić tę aplikację, zapisz kod w pliku .py (np. app.py) i uruchom w terminalu komendą: `streamlit run app.py`")